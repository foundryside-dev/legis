...
| CI green (tests + mypy) | 100% | `warpline-interfaces` branch: pytest 1225 passed, mypy clean (78 files) — CI-equivalent gate run locally; `main` green at 1.1.1 | 2026-06-25 |
